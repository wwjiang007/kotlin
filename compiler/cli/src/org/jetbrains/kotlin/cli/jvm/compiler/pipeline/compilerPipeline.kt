...
fun compileModulesUsingFrontendIrAndLaightTree(
    ...
    for (module in chunk) {
        ...
        val analysisResults = compileModuleToAnalyzedFir(compilerInput, compilerEnvironment, emptyList(), diagnosticsReporter)
