...
internal fun checkConstantArguments(
    ...
    when {
        ...
        expression is FirFunctionCall -> {
            ...
            if (symbol.fir.getAnnotationByClassId(FOLDABLE_ANNOTATION) == null) return ConstantArgumentKind.NOT_CONST
        ...
        expression is FirQualifiedAccessExpression -> {
            ...
            when {
                property.unwrapFakeOverrides().getAnnotationByClassId(FOLDABLE_ANNOTATION) != null -> {
                    return checkConstantArguments(expression.dispatchReceiver, session)
                }
