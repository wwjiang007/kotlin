...
class LightTree2Fir(
    ...
    fun buildFirFile(lightTreeKtFile: LightTreeKtFile): FirFile = with(lightTreeKtFile) {
        DeclarationsConverter(session, scopeProvider, lightTree)
