...
class Fir2IrConverter(
    ...
    internal fun processClassMembers(
        ...
        if (irConstructor != null && (irClass.isInline || irClass.isValue || irClass.isData)) {
            ...
            if (irClass.isValue) {
                allDeclarations += dataClassMembersGenerator.generateValueClassMembers(regularClass, irClass)
            }
            if (irClass.isData) {
